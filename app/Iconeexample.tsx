...
export default function Iconexample() {
    return (
        ...
        <div>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="black" className="size-12 hover:text-yellow-500">
            ...
            <p className="h-12 w-14 rotate-[0deg] hover:text-yellow-500  font-bold" style={{ color: 'black' }}>Sagar</p>
